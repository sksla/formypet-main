...
<body>
    ...
    <div class="breadc">
      ...
      <section class="main_content">
        ...
        <div >
            <h3 class="board_title">사진게시글 변경</h3>
        </div>
		...
		$(document).ready(function() {
		    ...
		    modal.find('.modal-footer button[data-dismiss="modal"]').click(function() {
                ...
                <form action="<%= contextPath %>/update.th" method="post" enctype="multipart/form-data">
                	<input type="hidden" name="no" value="<%= b.getBoardNo()%>">
                    <table class="table">
                        <tr>
                            <th>제목</th>
                            <td colspan="4"><input type="text" class="form-control" required name="title" value="<%= b.getBoardTitle()%>"></td>
                        </tr>
                        <tr>
                            <th>내용</th>
                            <td colspan="4"><textarea cols="30" rows="10" name="content" class="form-control" style="resize:none;" required ><%= b.getBoardContent() %></textarea></td>
                            <tr>
