...
<body>
    ...
    <!-- 브레드크럼 end -->
      ...
      <ul class="pagination justify-content-center">
	        ...
	        <% }else{ %>
	   	    <li class="page-item"><a class="page-link" href="<%= contextPath %>/list.th?page=<%= pi.getCurrentPage()-1%>">Previous</a></li>
	        <% } %>
	       ...
	       <% if(pi.getCurrentPage() == pi.getMaxPage()){ %>
	        ...
	        <% }else{ %>
	        <li class="page-item"><a class="page-link" href="<%= contextPath %>/list.th?page=<%= pi.getCurrentPage() + 1%>">Next</a></li>
	        <% } %>
