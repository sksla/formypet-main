...
<title>Insert title here</title>
	...
	<link rel="stylesheet" href="<%= request.getContextPath() %>/resources/css/board/boardList.css">
    ...
    <!-- 브레드크럼 end -->
        ...
        <div id="board_content">
          ...
          <div class="board_contentList">
            ...
            <div class="container">
              ...
              <form action="<%= contextPath %>/search.b" id="search_form" > 
      ...
      <ul class="pagination justify-content-center">
	        ...
	        <% for(int p=pi.getStartPage(); p<=pi.getEndPage(); p++){ %>
		        ...
		        <% }else{ %>
		        <li class="page-item"><a class="page-link" onclick="return searchPage(<%= p %>)"><%= p %></a></li>
		        <% } %>
	        <% } %>
