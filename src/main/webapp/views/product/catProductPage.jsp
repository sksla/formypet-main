...
<body>
	<div class="wrap">
		...
		<!-- category start -->
		<div class="category_area_cat">
			<div class="category">
				<table style="margin: 0 auto; width: 60%;">
					<tr>
						<th class="big_category" rowspan="2">사료</th>
						<td colspan="2" style="border-top: 0;">키튼<span>(1세 미만)</span></td>
						<td colspan="2" style="border-top: 0;">어덜트<span>(1~7세
								미만)</span></td>
						<td colspan="2" style="border-top: 0;">시니어<span>(7세
								이상)</span></td>
						<td colspan="2" style="padding-right: 70px; border-top: 0;">전연령</td>
					</tr>

					<tr>
						<td colspan="2">건식 사료</td>
						<td colspan="2">에어/동결 사료</td>
						<td colspan="4" style="text-align: left; padding-left: 30px;">주식캔</td>
			...
			<div class="category">
				<table style="margin: 0 auto; width: 60%;">
					<tr>
						<th colspan="2" rowspan="2" class="big_category">간식</th>
						<td>간식캔</td>
						<td>캣닢</td>
						<td>츄르</td>
						<td>트릿</td>
						<td>저키</td>
						<td>음료</td>
						<td colspan="5">영양/기능</td>
					</tr>
					<tr>
						<td>처방식</td>
						<td colspan="2" style="padding-left: 20px;">수제간식</td>
						<td colspan="9"></td>
			...
			<div class="category">
				<table style="margin: 0 auto; width: 60%;">
					<tr>
						<th class="big_category" colspan="2" rowspan="2">용품</th>
						<td>모래</td>
						<td colspan="2">위생용품</td>
						<td colspan="2" style="padding-right: 25px;">미용/관리</td>
						<td style="padding-left: 10px;">산책용품</td>
						<td colspan="2">캣타워/휠</td>
						<td>장난감</td>
						<td>스크래쳐</td>
						<td></td>
					...
					<tr>
						<td style="padding-right: 20px;">배변용품</td>
						<td colspan="2">의류/악세사리</td>

						<td>생활용품</td>
						<td colspan="2">급수/급식기</td>
			...
			<div class="product_main">
				...
				<ul class="pagination pagination-sm justify-content-center">
					...
					<li class="page-item"><a class="page-link"
						href="<%=contextPath%>/list.c?kind=C&page=<%=pi.getCurrentPage() - 1%>"
						tabindex="-1" aria-disabled="true">&lt;</a></li>
					<%} %>
					...
					<%}else{ %>
					<li class="page-item"><a class="page-link"
						href="<%=contextPath%>/list.c?kind=C&page=<%=p%>"><%=p %></a></li>
					<%} %>
					<%} %>
					...
					<%} else{ %>
					<li class="page-item"><a class="page-link"
						href="<%=contextPath%>/list.c?kind=C&page=<%=pi.getCurrentPage() + 1%>">&gt;</a></li>
					<%} %>
				</ul>
			</div>
			<%} %>
			...
			<script>
			    ...
			    $(function(){
			    	$(".thumbnail").click(function(){
				    	...
				    	$(".category_area_cat td").click(function(){
				    		
				    	 	$(".category_area_cat td").removeClass("active");
