...
<body>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>ForMyPet</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
  ...
  <script src="<%=contextPath %>/resources/vendor/quill/quill.min.js"></script>
