        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">FAQ 조회/수정</li>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">FAQ 조회/수정</h5>
                            <hr>
                            <br>

                            <form action="<%=contextPath %>/update.mfq" method="post">
                            	<input type="hidden" name="no" value="<%=f.getFaqNo()%>">
                                <table class="table" id="faq_detail_form">
                                    <tr>
                                        <th>제목</th>
                                        <td><input type="text" class="form-control" name="title" value="<%=f.getFaqTitle()%>" required ></td>
                                        
                                    </tr>
                                    <tr>
                                        <th>내용</th>
                                        <td><textarea cols="30" rows="10" class="form-control" style="resize: none;" required name="content"><%=f.getFaqContent() %></textarea></td>
                                    </tr>
                                    <tr>
