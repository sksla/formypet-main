...
<%
	...
	// 글번호,작성자아이디,카테고리명,제목,내용, 작성일, 글상태,답변자아이디,답변내용,답변일
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">1:1문의 답변 등록</li>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">1:1문의 답변 등록</h5>
                            <hr>
                            <br>

                            <form action="<%=contextPath %>/insert.mqa" method="post" id="insert_form">
                            	<input type="hidden" name="no" value="<%=q.getQnaNo()%>">
                                <table class="table" id="enroll_form">
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2" align="center">
                                            ...
                                            <button type="submit" class="btn btn-warning btn-sm enroll_btn">답변등록</button>
                                        </td>
                                    </tr>
                                </table>
                            </form>
