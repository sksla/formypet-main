...
/**
 * Servlet implementation class CatProductListPage
 */
@WebServlet("/list.c")
public class CatProductListPage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CatProductListPage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/product/catProductPage.jsp").forward(request, response);;
	}
