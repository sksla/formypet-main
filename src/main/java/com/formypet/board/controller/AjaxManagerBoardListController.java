...
/**
 * Servlet implementation class AjaxManagerBoardListController
 */
@WebServlet("/search.mbo")
public class AjaxManagerBoardListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxManagerBoardListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = bService.searchBoardListCount(hmKey);
		...
		List<Board> list = bService.searchBoardKeyword(hmKey, pi);
		
		// 포토게시판글일때의 첨부파일
		List<Attachment> atList = bService.selectAttachmentList();
