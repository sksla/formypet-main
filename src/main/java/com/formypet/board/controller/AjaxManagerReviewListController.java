...
/**
 * Servlet implementation class AjaxManagerReviewListController
 */
@WebServlet("/search.mrv")
public class AjaxManagerReviewListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxManagerReviewListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = bService.searchReviewListCount(hmKey);
		...
		List<Review> list = bService.searchReviewKeyword(hmKey, pi);
