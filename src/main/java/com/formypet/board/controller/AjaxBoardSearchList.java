...
/**
 * Servlet implementation class AjaxBoardSearchList
 */
@WebServlet("/search.b")
public class AjaxBoardSearchList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxBoardSearchList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		searchListCount = new BoardService().searchBoardListCount(category, search);
