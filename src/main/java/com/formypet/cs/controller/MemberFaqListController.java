...
/**
 * Servlet implementation class MemberFaqForm
 */
@WebServlet("/faq.fo")
public class MemberFaqListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Faq> list = new FaqService().selectFaqList();
		
		request.setAttribute("list", list);
		request.getRequestDispatcher("/views/cs/memberFaqForm.jsp").forward(request, response);
	}
